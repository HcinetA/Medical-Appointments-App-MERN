...
const AppointmentTable = () => {
    ...
    return (
      ...
      <p className="lead"><i className="fas fa-user"></i> Liste</p>
  ...
  <Table striped>
    ...
    <Table.Body>
      ...
      <Table.Cell>1</Table.Cell>
        ...
        <Table.Cell> <Button circular icon='x' disabled /></Table.Cell>
        <Table.Cell><Button primary>manage</Button></Table.Cell>
      </Table.Row>
      <Table.Row>
      <Table.Cell>1</Table.Cell>
        <Table.Cell>Amin Hcinet</Table.Cell>
      ...
      <Table.Cell>1</Table.Cell>
        ...
        <Table.Cell>15/10/2020</Table.Cell>
        <Table.Cell>John Doe</Table.Cell>
        <Table.Cell> <Button circular icon='check' disabled /></Table.Cell>
        <Table.Cell><Button primary>manage</Button></Table.Cell>
      </Table.Row> <Table.Row>
      <Table.Cell>1</Table.Cell>
        <Table.Cell>Amin Hcinet</Table.Cell>
